...
//                             <div className=" flex flex-col gap-2 my-2  text-[10px]   ">
//                               {products.length > 0 &&
//                                 products.map((item: any, index: number) => (
//                                   <p
//                                     key={index}
...
//                             <div className="flex flex-col gap-0.5 mt-3 text-[10px]">
//                               <p className=" font-semibold">WELCOME TO JACKET HOUSE</p>
//                               {/* <p>EXCHANGE IN 7 DAYS WITH INVOICE</p> */}
//                               <p>Exchange in 7 days with invoice</p>
//                               {/* <p>BETWEEN 10AM-7PM (Ph: {brabranchInfo.phone})</p> */}
...
//                               <p className=" opacity-0">.</p>
//                             </div>
//                             <div className="flex flex-col gap-0.5 my-2 text-[10px]">
...
//                             <div className="flex flex-col items-center mt-12 text-[10px] font-semibold">
