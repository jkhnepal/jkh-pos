...
import { createHeadquarterInventoryHandler, updateHeadquarterInventoryHandler, getHeadquarterInventoryHandler, getAllHeadquarterInventoryHandler, deleteHeadquarterInventoryHandler } from "../controller/headquarterInventory.controller";
